 ...
 * Changes: Adapted device types and constants for Hygon DCU hardware support.
 *
...
var (
	...
	DeviceTopologyConfigMapNamespace = "kube-system"
	DeviceTopologyConfigMapName      = "dcu-topology-info"
)
